...
FINDING_ARTEN = ("schriftdeutsch", "kohaerenz", "deckung", "fachlogik",
                 ...
                 "abwertung", "abwertung_anonym", "register", "rolle",
                 "fachbegriff", "cta", "struktur")
...
8. abwertung: Wird ein Kunde, ein Referenzkunde, eine genannte Person oder ihr früherer Zustand herabgesetzt? Zwei Bedingungen zusammen: erstens eine Formulierung, die Unvermögen zuschreibt ("falsch gebaut", "falsch umgesetzt", "schlechter", "niemand wusste", "keine Ahnung", "Chaos", "dilettantisch", "sich zu Tode"), und zweitens jemand, dem sie gilt, im selben Absatz: ein Name, eine Rolle, ein Team, "der Kunde", "die Gruppe". Fehlt der Adressat, ist es kein Befund. Kein Befund also: ein neutral beschriebener früherer Zustand (Dauer, Aufwand, Ergebnis), Kritik an Excel, an einem Verfahren ohne Person, an einer Praxis, die niemandem zugeordnet ist, und ein Missstand, den der Text niemandem anlastet. Vorschlag: derselbe Sachverhalt ohne Urteil.
